...
export default function KanbanBoardElement({
    ...
    const onDrop = (e, type) => {
        ...
        // if(type === status){
        //     setTasks( prevTasks => {
        //         const index = prevTasks[type].data.indexOf(content)
        //         const newData = [...prevTasks[type].data]
        //         newData.splice(index, 1)
        //         newData.splice(newIndex, 0, {content: content, status: type})
        //         const newTasks = {...prevTasks, [type]:{...prevTasks[type], data:newData}};
        //         return newTasks;
        //     })
        // }
    ...
    const handleEditClick = async(e, task, ref) => {
        // handleDelete()
    ...
    //             onDrop={(e) => onDrop(e, type)}
    //         >
                // <Typography text={title} elementType="h2" color="white" />
                //     {
                //         tasks.map( el => (
                //             <Task key={el.content} task={el} />
                //             ))
                //     }
    //         </StyledKanbanBoardElementTodo>
    //     )
